...
function redirectToLogin(loginPath, currentPath) {
    ...
    if (isPublicRoute(currentPath))
        return;
    if (normalizedCurrentPath === normalizedLoginPath)
        return;
...
export function initAuthGate(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const loginPath = (_b = options === null || options === void 0 ? void 0 : options.loginPath) !== null && _b !== void 0 ? _b : "/login";
        const currentPath = window.location.pathname;
...
window.addEventListener("auth:expired", (event) => {
    ...
    window.setTimeout(() => {
        var _a;
        if ((_a = authExpiredEvent.detail) === null || _a === void 0 ? void 0 : _a.suppressRedirect)
            return;
