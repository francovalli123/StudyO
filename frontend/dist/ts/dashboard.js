...
const IS_TOUCH_DEVICE = typeof window !== 'undefined' &&
    (((_a = window.matchMedia) === null || _a === void 0 ? void 0 : _a.call(window, '(hover: none), (pointer: coarse)').matches) ||
...
function loadPomodoroStats() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const userTimezone = (yield getCurrentUser()).timezone || Intl.DateTimeFormat().resolvedOptions().timeZone;
            const getDateKeyInTimezone = (dateInput, tz) => (new Intl.DateTimeFormat('en-CA', {
                timeZone: tz,
                year: 'numeric',
                month: '2-digit',
                day: '2-digit',
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (chartContainer && chartParent) {
                ...
                const svg = chartContainer;
                const svgElement = chartContainer;
                const viewportWidth = Math.max(220, Math.floor(svgElement.clientWidth || chartParent.clientWidth || 450));
                const viewportHeight = Math.max(120, Math.floor(svgElement.clientHeight || 160));
...
function toggleHabitCompletion(habitId, complete) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const response = yield fetch(`${BASE_URL}/habits/${habitId}/complete/`, {
...
(() => {
    ...
    function getPendingPomodoroSessionsStorageKey(authScope) {
        const scope = authScope === undefined ? getToken() : authScope;
        if (!scope)
            return `${PENDING_POMODORO_SESSIONS_KEY}:anonymous`;
        return `${PENDING_POMODORO_SESSIONS_KEY}:${scope}`;
    }
    function getPendingPomodoroCandidateScopes(currentScope) {
        const scopes = [];
        const current = currentScope !== null && currentScope !== void 0 ? currentScope : getToken();
        const lastScope = localStorage.getItem(PENDING_POMODORO_LAST_SCOPE_KEY);
        if (current)
            scopes.push(current);
        if (lastScope && lastScope !== current)
            scopes.push(lastScope);
        scopes.push('anonymous');
        return scopes;
    }
    function readPendingPomodoroSessions(authScope) {
        try {
    ...
    function writePendingPomodoroSessions(items, authScope) {
    ...
    function enqueuePendingPomodoroSession(payload, authScope) {
        const scope = authScope !== null && authScope !== void 0 ? authScope : getToken();
        if (scope) {
            localStorage.setItem(PENDING_POMODORO_LAST_SCOPE_KEY, scope);
        }
        const pending = readPendingPomodoroSessions(authScope);
        const alreadyQueued = pending.some((item) => {
            var _a, _b;
            return (item === null || item === void 0 ? void 0 : item.start_time) === payload.start_time &&
                (item === null || item === void 0 ? void 0 : item.end_time) === payload.end_time &&
                Number(item === null || item === void 0 ? void 0 : item.duration) === Number(payload.duration) &&
                Number((_a = item === null || item === void 0 ? void 0 : item.subject) !== null && _a !== void 0 ? _a : -1) === Number((_b = payload.subject) !== null && _b !== void 0 ? _b : -1);
        });
        if (!alreadyQueued) {
    ...
    function readAllPendingPomodoroSessionsForRetry() {
        var _a;
        const merged = [];
        const seen = new Set();
        ...
        for (const scope of scopes) {
            ...
            for (const item of items) {
                const dedupeKey = `${item === null || item === void 0 ? void 0 : item.start_time}|${item === null || item === void 0 ? void 0 : item.end_time}|${item === null || item === void 0 ? void 0 : item.duration}|${(_a = item === null || item === void 0 ? void 0 : item.subject) !== null && _a !== void 0 ? _a : ''}`;
    ...
    function flushPendingPomodoroSessions() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    function showAuthExpiredPomodoroNoticeAndRedirect() {
        return __awaiter(this, void 0, void 0, function* () {
            if (authExpiryNoticeVisible)
                return;
            ...
            try {
                yield showAlertModal('Tu sesión expiró mientras guardábamos tu Pomodoro. La sesión de estudio quedó guardada y se sincronizará cuando vuelvas a iniciar sesión.', 'Sesión expirada');
            }
            catch (e) {
                // noop
            }
    ...
    function handleOnboarding() {
        ...
        if (ctx === null || ctx === void 0 ? void 0 : ctx.active)
            return;
    ...
    function applyPomodoroOnboardingStep() {
        ...
        if (onboardingStep === 'CREATE_SUBJECT') {
            showOnboardingOverlay({
                title: ((_a = t().onboarding) === null || _a === void 0 ? void 0 : _a.stepCreateSubjectTitle) || 'Paso 1: Creá tu primera asignatura',
                body: ((_b = t().onboarding) === null || _b === void 0 ? void 0 : _b.stepCreateSubjectBody) || 'Creá 1 asignatura para activar el tracking real de tu estudio.',
                primaryText: ((_c = t().onboarding) === null || _c === void 0 ? void 0 : _c.createSubject) || 'Crear asignatura',
                primaryHref: '/subjects',
                lockClose: true,
                allowSkip: true,
                onSkip: () => __awaiter(this, void 0, void 0, function* () { try {
                    yield skipOnboarding();
                }
                catch (_) { } hideOnboardingOverlay(); }),
            });
            return;
        }
        if (onboardingStep === 'CREATE_HABIT') {
            showOnboardingOverlay({
                title: ((_d = t().onboarding) === null || _d === void 0 ? void 0 : _d.stepCreateHabitTitle) || 'Paso 2: Creá un hábito',
                body: ((_e = t().onboarding) === null || _e === void 0 ? void 0 : _e.stepCreateHabitBody) || 'Ahora creá un hábito y revisá “Hábito clave”.',
                primaryText: ((_f = t().onboarding) === null || _f === void 0 ? void 0 : _f.goToHabits) || 'Ir a hábitos',
                primaryHref: '/habits',
                lockClose: true,
                allowSkip: true,
                onSkip: () => __awaiter(this, void 0, void 0, function* () { try {
        ...
        if (onboardingStep === 'CONFIG_POMODORO') {
            showOnboardingOverlay({
                title: ((_g = t().onboarding) === null || _g === void 0 ? void 0 : _g.stepConfigPomodoroTitle) || 'Paso 3: Configurá Pomodoro',
                body: ((_h = t().onboarding) === null || _h === void 0 ? void 0 : _h.stepConfigPomodoroBody) || 'Definí una materia por defecto para registrar bien tus sesiones.',
                primaryText: t().dashboard.pomodoroSettings,
                lockClose: true,
                onPrimary: () => {
                    hideOnboardingOverlay();
                    settingsBtn === null || settingsBtn === void 0 ? void 0 : settingsBtn.dispatchEvent(new Event('click'));
                },
            });
            return;
        }
        if (onboardingStep === 'START_SESSION') {
            if (!defaultSubjectId) {
                ...
                showOnboardingOverlay({
                    ...
                    lockClose: true,
                    onPrimary: () => __awaiter(this, void 0, void 0, function* () {
                        try {
                            yield completeOnboarding();
                            onboardingStep = 'DONE';
                            hideOnboardingOverlay();
                            try {
                                showAlertModal('Onboarding completado. Ya podes explorar StudyO libremente.');
                            }
                            catch (e) { }
                        }
                        catch (e) {
    ...
    function loadSettings() {
        try {
            ...
            if (raw) {
                ...
                if (typeof parsed.defaultSubjectId === 'number')
                    defaultSubjectId = parsed.defaultSubjectId;
            }
        }
    ...
    function saveSettings() {
        localStorage.setItem('pomodoroSettings', JSON.stringify(Object.assign(Object.assign({}, settings), { defaultSubjectId })));
    }
    /**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (authExpiredDuringPomodoroSave || isAuthSessionExpiredError(e)) {
                    ...
                    yield showAuthExpiredPomodoroNoticeAndRedirect();
                    return null;
                }
    ...
    document.addEventListener('DOMContentLoaded', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            yield flushPendingPomodoroSessions();
        }
        catch (e) {
        ...
        updateDisplay();
        if (playBtn)
            playBtn.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () { if (isRunning)
                pauseTimer();
            else
                yield startTimer(); }));
        if (skipBtn)
