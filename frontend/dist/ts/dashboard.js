    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            weeklySessions.forEach(session => {
                ...
                const key = subjectId !== null && !isNaN(subjectId)
                    ? subjectId
                    : -1;
            ...
            const conicGradient = subjectData
                ...
                const segmentPercent = index === subjectData.length - 1
                    ? 100 - currentPercent
                    : subject.percentage;
...
(() => {
    ...
    function updateDisplay() {
        ...
        try {
            ...
            if (pomodorosCountEl)
                pomodorosCountEl.textContent = `${pomodoroLabel[lang] || pomodoroLabel.es}: ${completedCycles}`;
