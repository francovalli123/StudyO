...
function init() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const possibleAvatar = resolveAvatarUrl((user.avatar_url || user.avatar || user.photo || user.profile_image));
            if (possibleAvatar)
        ...
        avatarInput.addEventListener('change', (e) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const newUrl = resolveAvatarUrl((res === null || res === void 0 ? void 0 : res.avatar_url) || (res === null || res === void 0 ? void 0 : res.avatar) || (res === null || res === void 0 ? void 0 : res.url) || (res === null || res === void 0 ? void 0 : res.photo) || (res === null || res === void 0 ? void 0 : res.profile_image));
                if (newUrl && avatarImg)
