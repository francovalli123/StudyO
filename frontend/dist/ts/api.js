...
export function getSignupCaptcha() {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield fetch(`${BASE_URL}/signup/captcha/`, {
            method: "GET",
            headers: { "Content-Type": "application/json" },
            credentials: "include"
        });
...
export function register(username, email, password, firstName, lastName, country, captchaId, captchaAnswer) {
    return __awaiter(this, void 0, void 0, function* () {
...
export function updateEvent(id, event) {
    return __awaiter(this, void 0, void 0, function* () {
        return apiPatch(`/events/${id}/`, event);
    });
}
...
export function completeEvent(id) {
    return __awaiter(this, void 0, void 0, function* () {
        return apiPatch(`/events/${id}/complete/`, {});
    });
}
