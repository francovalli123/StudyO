...
export const translations: Record<Language, Translations> = {
    es: {
        ...
        reading: {
            ...
            subtitle: 'Registr? manualmente tu progreso de lectura.',
            addBook: 'A?adir libro',
            emptyTitle: 'Tu biblioteca est? vac?a',
            emptyDesc: 'Agreg? tus lecturas y control? tu avance sin subir PDFs.',
            emptyCta: 'Agreg? tu primer libro',
            formTitle: 'T?tulo',
            formTitlePlaceholder: 'Ej: C?lculo Diferencial',
            formAuthor: 'Autor',
            formAuthorPlaceholder: 'Ej: Stewart',
            formTotalPages: 'Total de p?ginas',
            ...
            totalPagesRequired: 'Debes indicar el total de p?ginas.',
            totalPagesInvalid: 'El total de p?ginas debe ser mayor a 0.',
            deleteBook: 'Eliminar',
            deleteError: 'No se pudo eliminar el libro.',
            updateProgress: 'Actualizar progreso',
            updateProgressTitle: 'Actualizar progreso',
            lastPageLabel: '?ltima p?gina le?da',
            lastPageInvalid: 'La p?gina debe ser 0 o m?s.',
            lastPageExceed: 'La p?gina no puede superar el total.',
    ...
    pt: {
        ...
        reading: {
            ...
            uploading: 'Salvando...',
            uploadError: 'N?o foi poss?vel criar o livro.',
            selectPdfError: 'Selecione um PDF.',
            totalPagesRequired: 'Informe o total de p?ginas.',
            totalPagesInvalid: 'O total de p?ginas deve ser maior que 0.',
            deleteBook: 'Excluir',
            deleteError: 'N?o foi poss?vel excluir o livro.',
            updateProgress: 'Atualizar progresso',
            updateProgressTitle: 'Atualizar progresso',
            lastPageLabel: '?ltima p?gina lida',
            lastPageInvalid: 'A p?gina deve ser 0 ou maior.',
            lastPageExceed: 'A p?gina n?o pode passar do total.',
            noteLabel: 'Nota (opcional)',
            noteHint: 'M?x. 200 caracteres.',
