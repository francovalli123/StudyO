...
export interface Translations {
    ...
    reading: {
        ...
        formTotalPagesPlaceholder: string;
        formSubject: string;
        ...
        totalPagesRequired: string;
        totalPagesInvalid: string;
        deleteBook: string;
        deleteError: string;
        updateProgress: string;
        updateProgressTitle: string;
        lastPageLabel: string;
        lastPageInvalid: string;
        lastPageExceed: string;
        noteLabel: string;
        noteHint: string;
        notePlaceholder: string;
        progressSaveError: string;
        lastNoteLabel: string;
        pagesTotalLabel: string;
        progressLabel: string;
        pagesLabel: string;
        noSubject: string;
        completed: string;
...
export const translations: Record<Language, Translations> = {
    es: {
        profile: {
            ...
            taskReminders: 'Recordatorios de objetivos',
            taskRemindersDesc: 'Recibir alertas para objetivos semanales.',
        ...
        reading: {
            ...
            subtitle: 'Registr\u00e1 manualmente tu progreso de lectura.',
            addBook: 'A\u00f1adir libro',
            emptyTitle: 'Tu biblioteca est\u00e1 vac\u00eda',
            emptyDesc: 'Agreg\u00e1 tus lecturas y control\u00e1 tu avance sin subir PDFs.',
            emptyCta: 'Agreg\u00e1 tu primer libro',
            formTitle: 'T\u00edtulo',
            formTitlePlaceholder: 'Ej: C\u00e1lculo Diferencial',
            formAuthor: 'Autor',
            formAuthorPlaceholder: 'Ej: Stewart',
            formTotalPages: 'Total de p\u00e1ginas',
            formTotalPagesPlaceholder: 'Ej: 320',
            formSubject: 'Materia',
            formSubjectPlaceholder: 'Selecciona una materia',
            formFile: 'Archivo PDF',
            formFileHint: 'Solo PDF. M\u00e1ximo 50MB.',
            uploadBook: 'Guardar libro',
            uploading: 'Guardando...',
            uploadError: 'Error al crear el libro.',
            selectPdfError: 'Debes seleccionar un PDF.',
            totalPagesRequired: 'Debes indicar el total de p\u00e1ginas.',
            totalPagesInvalid: 'El total de p\u00e1ginas debe ser mayor a 0.',
            deleteBook: 'Eliminar',
            deleteError: 'No se pudo eliminar el libro.',
            updateProgress: 'Actualizar progreso',
            updateProgressTitle: 'Actualizar progreso',
            lastPageLabel: '\u00daltima p\u00e1gina le\u00edda',
            lastPageInvalid: 'La p\u00e1gina debe ser 0 o m\u00e1s.',
            lastPageExceed: 'La p\u00e1gina no puede superar el total.',
            noteLabel: 'Nota (opcional)',
            noteHint: 'M\u00e1x. 200 caracteres.',
            notePlaceholder: 'Ej: Lo dej\u00e9 en la secci\u00f3n 3.2',
            progressSaveError: 'No se pudo guardar el progreso.',
            lastNoteLabel: '\u00daltima nota',
            pagesTotalLabel: 'p\u00e1ginas totales',
    ...
    en: {
        profile: {
            ...
            taskReminders: 'Objetive Reminders',
            taskRemindersDesc: 'Receive alerts for weekly objetives.',
        ...
        reading: {
            ...
            subtitle: 'Manually track your reading progress.',
            addBook: 'Add book',
            emptyTitle: 'Your library is empty',
            emptyDesc: 'Add your readings and track progress without PDFs.',
            emptyCta: 'Add your first book',
            formTitle: 'Title',
            formTitlePlaceholder: 'Example: Calculus',
            formAuthor: 'Author',
            formAuthorPlaceholder: 'Example: Stewart',
            formTotalPages: 'Total pages',
            formTotalPagesPlaceholder: 'Example: 320',
            formSubject: 'Subject',
            formSubjectPlaceholder: 'Select a subject',
            formFile: 'PDF file',
            formFileHint: 'PDF only. Max 50MB.',
            uploadBook: 'Save book',
            uploading: 'Saving...',
            uploadError: 'Could not create the book.',
            selectPdfError: 'Please select a PDF.',
            totalPagesRequired: 'Total pages is required.',
            totalPagesInvalid: 'Total pages must be greater than 0.',
            deleteBook: 'Delete',
            deleteError: 'Could not delete the book.',
            updateProgress: 'Update progress',
            updateProgressTitle: 'Update progress',
            lastPageLabel: 'Last page read',
            lastPageInvalid: 'Page must be 0 or higher.',
            lastPageExceed: 'Page cannot exceed total pages.',
    ...
    zh: {
        profile: {
            ...
            habitReminders: '目标提醒',
            habitRemindersDesc: '接收每周目标的提醒通知。',
        ...
        reading: {
            ...
            addBook: '\u6dfb\u52a0\u4e66\u7c4d',
            emptyTitle: '\u4f60\u7684\u4e66\u5e93\u4e3a\u7a7a',
            emptyDesc: '\u6dfb\u52a0\u9605\u8bfb\u5185\u5bb9\uff0c\u65e0\u9700\u4e0a\u4f20 PDF \u5373\u53ef\u8ddf\u8e2a\u8fdb\u5ea6\u3002',
            emptyCta: '\u6dfb\u52a0\u7b2c\u4e00\u672c\u4e66',
            formTitle: '\u6807\u9898',
            formTitlePlaceholder: '\u4f8b\u5982\uff1a\u5fae\u79ef\u5206',
            formAuthor: '\u4f5c\u8005',
            formAuthorPlaceholder: '\u4f8b\u5982\uff1aStewart',
            formTotalPages: '\u603b\u9875\u6570',
            formTotalPagesPlaceholder: '\u4f8b\u5982\uff1a320',
            formSubject: '\u79d1\u76ee',
            formSubjectPlaceholder: '\u9009\u62e9\u79d1\u76ee',
            formFile: 'PDF \u6587\u4ef6',
            formFileHint: '\u4ec5 PDF\uff0c\u6700\u5927 50MB\u3002',
            uploadBook: '\u4fdd\u5b58\u4e66\u7c4d',
            uploading: '\u6b63\u5728\u4fdd\u5b58...',
            uploadError: '\u65e0\u6cd5\u521b\u5efa\u4e66\u7c4d\u3002',
            selectPdfError: '\u8bf7\u9009\u62e9 PDF\u3002',
            totalPagesRequired: '\u8bf7\u586b\u5199\u603b\u9875\u6570\u3002',
            totalPagesInvalid: '\u603b\u9875\u6570\u5fc5\u987b\u5927\u4e8e 0\u3002',
            deleteBook: '\u5220\u9664',
            deleteError: '\u65e0\u6cd5\u5220\u9664\u4e66\u7c4d\u3002',
            updateProgress: '\u66f4\u65b0\u8fdb\u5ea6',
            updateProgressTitle: '\u66f4\u65b0\u8fdb\u5ea6',
            lastPageLabel: '\u6700\u540e\u9605\u8bfb\u9875',
            lastPageInvalid: '\u9875\u7801\u5fc5\u987b\u4e3a 0 \u6216\u66f4\u5927\u3002',
            lastPageExceed: '\u9875\u7801\u4e0d\u80fd\u8d85\u8fc7\u603b\u9875\u6570\u3002',
            noteLabel: '\u5907\u6ce8\uff08\u53ef\u9009\uff09',
            noteHint: '\u6700\u591a 200 \u4e2a\u5b57\u7b26\u3002',
            notePlaceholder: '\u4f8b\u5982\uff1a\u505c\u5728\u7b2c 3.2 \u8282',
            progressSaveError: '\u65e0\u6cd5\u4fdd\u5b58\u8fdb\u5ea6\u3002',
            lastNoteLabel: '\u6700\u540e\u5907\u6ce8',
            pagesTotalLabel: '\u603b\u9875\u6570',
            progressLabel: '\u8fdb\u5ea6',
            pagesLabel: '\u9875',
    ...
    pt: {
        profile: {
            ...
            habitReminders: 'Lembretes de Objetivos',
            habitRemindersDesc: 'Lembretes suaves para objetivos semanais.',
        ...
        reading: {
            ...
            subtitle: 'Acompanhe seu progresso de leitura manualmente.',
            addBook: 'Adicionar livro',
            emptyTitle: 'Sua biblioteca est\u00e1 vazia',
            emptyDesc: 'Adicione suas leituras e acompanhe o progresso sem PDFs.',
            emptyCta: 'Adicione seu primeiro livro',
            formTitle: 'T\u00edtulo',
            formTitlePlaceholder: 'Ex: C\u00e1lculo Diferencial',
            formAuthor: 'Autor',
            formAuthorPlaceholder: 'Ex: Stewart',
            formTotalPages: 'Total de p\u00e1ginas',
            formTotalPagesPlaceholder: 'Ex: 320',
            formSubject: 'Mat\u00e9ria',
            formSubjectPlaceholder: 'Selecione uma mat\u00e9ria',
            formFile: 'Arquivo PDF',
            formFileHint: 'Apenas PDF. M\u00e1ximo 50MB.',
            uploadBook: 'Salvar livro',
            uploading: 'Salvando...',
            uploadError: 'N\u00e3o foi poss\u00edvel criar o livro.',
            selectPdfError: 'Selecione um PDF.',
            totalPagesRequired: 'Informe o total de p\u00e1ginas.',
            totalPagesInvalid: 'O total de p\u00e1ginas deve ser maior que 0.',
            deleteBook: 'Excluir',
            deleteError: 'N\u00e3o foi poss\u00edvel excluir o livro.',
            updateProgress: 'Atualizar progresso',
            updateProgressTitle: 'Atualizar progresso',
            lastPageLabel: '\u00daltima p\u00e1gina lida',
            lastPageInvalid: 'A p\u00e1gina deve ser 0 ou maior.',
            lastPageExceed: 'A p\u00e1gina n\u00e3o pode passar do total.',
            noteLabel: 'Nota (opcional)',
            noteHint: 'M\u00e1x. 200 caracteres.',
            notePlaceholder: 'Ex: Parei na se\u00e7\u00e3o 3.2',
            progressSaveError: 'N\u00e3o foi poss\u00edvel salvar o progresso.',
            lastNoteLabel: '\u00daltima nota',
            pagesTotalLabel: 'p\u00e1ginas totais',
